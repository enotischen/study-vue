...
function appendTabToElement(editor, dialog, tabsElement, numberOfTabs, i) {
  ...
  var tabPanelContentHtml = '<div class="tab-pane-content">' + tabName + ' 頁籤內容(Content)</div>';

  // Template html for a tab and tabPanel (http://getbootstrap.com/javascript/#tabs-examples).
  var tabHtml             = '<li role="presentation"><a class="tab-link" href="#' + tabIdentifier + '" aria-controls="' + tabIdentifier + '" role="tab" data-toggle="tab">' + tabName + ' 頁籤名稱(Name)</a></li>';
